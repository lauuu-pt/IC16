...
let generateShop = () => {
  return (shop.innerHTML = shopItemsData
    .map((x) => {
     ...
     return `
     <div class="box ${categoria} ${gluten} ${lactose}">
    ...
    <div id="popup1" class="overlay1" style="z-index:100;">
       <div class="popup1">
          ...
          <div class="content1">
             ...
             <a class="textt" href="assets\js\src\Data.js"></a>
...
/**funcoes gluten e lactose */
function stickyheaddsadaer1(obj) {
  if($(obj).is(":checked")){
      filterObjects("nao-gluten");
  }else{
    filterObjects("all");
  }
...
function stickyheaddsadaer2(obj) {
  if($(obj).is(":checked")){
      filterObjects("nao-lactose");
  }else{
    filterObjects("all");
  }
